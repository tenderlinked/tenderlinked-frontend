...
const metadata: Metadata = {
  title: "Register & Create Account | Enfycon Admin Dashboard",
  description:
    "Create a new user account and get started with the Enfycon Admin Dashboard built with Next.js and Tailwind CSS.",
};
