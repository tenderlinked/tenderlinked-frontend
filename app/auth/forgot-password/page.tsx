...
const metadata: Metadata = {
  title: "Forgot Password & Account Recovery | Enfycon Admin Dashboard",
  description:
    "Recover your account by resetting your password in the Enfycon Admin Dashboard built with Next.js and Tailwind CSS.",
};
