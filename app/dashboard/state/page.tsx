    ...
    <div className="flex flex-col gap-8 w-full pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-white border-slate-100 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:border-purple-100 group">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-500 font-medium tracking-wide">Organisations Crawled</p>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col">
          <h2 className="text-xl font-bold text-slate-800 tracking-tight">State Tenders</h2>
          <p className="text-slate-500 text-sm">State-level tenders from NICGEP portal.</p>
        </div>
